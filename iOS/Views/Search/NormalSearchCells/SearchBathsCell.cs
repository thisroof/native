	...
	public partial class SearchBathsCell : UITableViewCell, ISearchCell
	{
		...
		public void HandleExpandTap()
		{
			...
			if (expanded) {
				...
				cellHeight = seg_bathCount.Frame.Bottom + 8;
			} else {
		...
		private void InitUI()
		{
			...
			seg_bathCount.ValueChanged += (object sender, EventArgs e) => {
				masterView.ViewModelInstance.MinBaths = (int)seg_bathCount.SelectedSegment;
			};
		}
	}
}
