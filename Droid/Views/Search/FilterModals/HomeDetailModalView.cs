...
{
	public class HomeDetailModalView : MvxDialogFragment
	{
		public HomeDetailModalView() 
		{
		...
		public override View OnCreateView (LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState)
		{
			...
			View view = this.BindingInflate (Resource.Layout.fragment_search_modal_homedetail, null);
