...
{
	public class SignupView : BaseMvxFragment, MediaPlayer.IOnPreparedListener, ISurfaceHolderCallback, GraphRequest.ICallback
	{
		...
		public override View OnCreateView (LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState)
		{
			...
			View view = this.BindingInflate (Resource.Layout.fragment_signup, null);
